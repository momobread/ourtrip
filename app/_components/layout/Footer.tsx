const Footer = () => {
  return (
    <footer className="grid h-[30rem] grid-rows-[4rem_4rem_4rem_4rem] items-center justify-center bg-grey-200 px-10 py-20 text-center">
      <p>
        <span className="text-[1.2rem] sm:text-[2rem]">
          법인명(상호) : 주식회사 레이컴펀; 대표자(성명) : 박시은 사업자 등록번호 : 999-99-99999
        </span>
      </p>
      <p>
        <span className="text-[1.2rem] sm:text-[2rem]">
          통신판매업 신고 : 2025-대구-0819 전화 : 1999-0819 팩스 : 010-7771-7149
        </span>
      </p>
      <p>
        <span className="text-[1.2rem] sm:text-[2rem]">
          주소 : 99999 전라북도 익산시 신동 원광대학교 프라임관 2층 랩실
        </span>
      </p>
      <p>
        <span className="text-[1.2rem] sm:text-[2rem]">
          COPYRIGHT &copy; 2025시은컴퍼니. ALL RIGHT RESERVED.
        </span>
      </p>
    </footer>
  );
